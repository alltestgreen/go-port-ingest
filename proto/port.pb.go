// protoc --go_out=. --go-grpc_out=. proto/port.proto
...
type SubmitPortResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SubmitPortResponse) Reset() {
	*x = SubmitPortResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SubmitPortResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubmitPortResponse) ProtoMessage() {}

func (x *SubmitPortResponse) ProtoReflect() protoreflect.Message {
	mi := &file_port_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubmitPortResponse.ProtoReflect.Descriptor instead.
func (*SubmitPortResponse) Descriptor() ([]byte, []int) {
	return file_port_proto_rawDescGZIP(), []int{1}
}

func (x *SubmitPortResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SubmitPortResponse) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
var file_port_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x22, 0x42, 0x0a, 0x12, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x50, 0x6f,
	...
	0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x32, 0x43, 0x0a, 0x0b, 0x50, 0x6f, 0x72, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x6d, 0x69,
	0x74, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x0b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x50, 0x6f,
	0x72, 0x74, 0x1a, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69,
	0x74, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a,
...
var file_port_proto_goTypes = []interface{}{
	...
	(*SubmitPortResponse)(nil), // 1: proto.SubmitPortResponse
}
var file_port_proto_depIdxs = []int32{
	0, // 0: proto.PortService.SubmitPort:input_type -> proto.Port
	1, // 1: proto.PortService.SubmitPort:output_type -> proto.SubmitPortResponse
...
func file_port_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_port_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubmitPortResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
